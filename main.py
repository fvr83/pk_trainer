...
def play(combo_pool, combos_order, mode_str, spot_string, spot_actions, mode_depth, positions_actions, pot_odds_and_stacks, actions_frequencies, combos_dict):
    ...
    seats[0].hero_cards_label.config(text=combo, bg="white", font=("Arial", 20, "bold"), width=3, anchor="center")
...
class Seat():
    ...
    def draw_seat(self):
        ...
        if self.index == 0:
            self.hero_cards_label = tk.Label(root, text="", bg="white", font=("Arial", 20, "bold"), width=3, anchor="center")
            self.hero_cards_label.place(x=cards_center_x - 28, y=cards_center_y - 18)
...
btn_radius = 7
cards_width = 64
cards_height = (cards_width / 2) * 1.36
